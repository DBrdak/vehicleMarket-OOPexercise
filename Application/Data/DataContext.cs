...
namespace Application.Data
{
    public static class DataContext
    {
        ...
        private static void Seed()
        {
            ...
            {
                new Truck("Daf", "XF", 2012, 765192, 490, 12900, Fuel.Diesel, "Katowice", "+48701234567", 18900, 26600, "1360x240x250", 3, TruckType.RefrigeratedTruck, 2500),
                ...
                new Truck("Volvo", "FH", 2014, 820145, 500, 14700, Fuel.Diesel, "Gdańsk", "+48787878787", 25900, 40000, "1360x260x270", 2, TruckType.FlatbedTruck, 8000),
                ...
                new Truck("MAN", "TGS", 2016, 912345, 440, 11500, Fuel.Diesel, "Łódź", "+48601829584", 149000, 28000, "2200x240x240", 3, TruckType.BoxTruck, 3500),
                ...
                new Truck("Scania", "R500", 2010, 651234, 500, 12000, Fuel.Diesel, "Katowice", "+48774455632", 123000, 25000, "1360x250x250", 3, TruckType.DumpTruck, 2000),
                ...
                new Truck("Iveco", "Eurocargo", 2017, 512345, 210, 7500, Fuel.Diesel, "Warszawa", "+48601122334", 97000, 15000, "630x220x240", 2, TruckType.ContainerTruck, 2000),
                new Truck("Mercedes-Benz", "Actros", 2018, 845230, 430, 18000, Fuel.Diesel, "Warsaw", "+48221234567", 145000, 31000, "2500x250x800", 2, TruckType.DumpTruck, 10000),
                ...
                new Truck("Volvo", "FH", 2017, 721908, 540, 12000, Fuel.Diesel, "Lodz", "+48662345678", 110000, 21000, "1200x240x250", 2, TruckType.ContainerTruck, 14000),
                ...
                new Truck("MAN", "TGX", 2020, 923472, 500, 20000, Fuel.Diesel, "Gdansk", "+48771234567", 178000, 36000, "1360x260x250", 3, TruckType.RefrigeratedTruck, 3000),
                ...
                new Truck("Iveco", "Stralis", 2019, 672395, 460, 16000, Fuel.Diesel, "Krakow", "+48771234567", 135000, 26000, "2500x240x800", 2, TruckType.FlatbedTruck, 8000),
